package com.example.login_register.presentation.screens.login
...
import com.example.login_register.presentation.viewmodels.LoginViewModel
import com.example.login_register.util.EmailUtils.isEmailValid
import com.example.login_register.util.PasswordUtils.checkPasswordMinRequirement
        ...
        Column(
            ...
            StandardTextField(
                ...
                onValueChange = {
                    ...
                    if (!viewModel.passwordText.value.checkPasswordMinRequirement()) {
                        viewModel.setPasswordError("Password requirement not met")
